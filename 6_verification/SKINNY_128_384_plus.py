# Skinny-128-384+ Python Implementation
...
# tabulated LFSR for Skinny-128-384+
...
# number of rounds and number of tweakey bytes in Skinny-128-384+
NB_ROUNDS = 40
TWEAK_LENGTH = 48
...
def skinny_enc(plaintext, tweakey):
    ...
    for i in range(NB_ROUNDS-1):
        ...
        if DEBUG==1: print("Plaintext = " + "".join("{:02X}".format(_) for _ in plaintext))
        if DEBUG==1: print("Tweakey = " + "".join("{:02X}".format(_) for _ in tk[i]))
